...
const totalPagar = computed(() =>{
    return props.carrito.reduce((total,prodcucto) => total + (prodcucto.cantidad * prodcucto.precio),0 )
})
</script>
<template>
                        ...
                        <div id="carrito" class="bg-white p-3">
                           ...
                           <div v-else>
                            <table class="w-100 table">
                                ...
                                <tbody>
                                    <tr
                                    v-for="prodcucto in carrito"
                                    >
                                        <td>
                                            <img 
                                            class="img-fluid" 
                                            :src="'/img/'+ prodcucto.imagen +'.jpg'"
                                            :alt="'imagen guitarra' +prodcucto.nombre"
                                            >
                                        </td>
                                        <td>{{ prodcucto.nombre }}</td>
                                        <td class="fw-bold">
                                                {{prodcucto.precio}}
                                        </td>
                                        <td class="flex align-items-start gap-4">
                                            <button
                                                type="button"
                                                class="btn btn-dark"
                                                @click="$emit('decrementar-cantidad',prodcucto.id)"
                                            >
                                                -
                                            </button>
                                               {{prodcucto.cantidad}}
                                            <button
                                                type="button"
                                                class="btn btn-dark"
                                                @click="$emit('incrementar-cantidad',prodcucto.id)"
                                            >
                                                +
                                            </button>
                                        </td>
                                        <td>
                                            <button
                                                ...
                                                type="button"
                                                @click="$emit('eliminar-producto',prodcucto.id)"
                                            >
                                                X
                                            </button>
                                        </td>
